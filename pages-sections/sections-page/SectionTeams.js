...
import teamsStyle from "assets/jss/nextjs-material-tim-andrus/pages/sectionsSections/teamsStyle.js";
      ...
      <div className={classes.team}>
        <div className={classes.container}>
          <GridContainer>
            ...
            >
              <h2 className={classes.title}>My Awesome Team 1</h2>
              ...
              <Card profile plain>
                ...
                <CardBody>
                  ...
                  <p className={classes.description}>
                    And I love you like Kanye loves Kanye. I need to restart
            ...
            <GridItem xs={12} sm={3} md={3}>
              <Card profile plain>
                ...
                <CardBody>
                  ...
                  <p className={classes.description}>
                    And I love you like Kanye loves Kanye. I really need to
