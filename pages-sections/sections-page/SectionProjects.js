...
import projectsStyle from "assets/jss/nextjs-material-tim-andrus/pages/sectionsSections/projectsStyle.js";
              ...
              >
                <CardBody background>
                  ...
                  <p className={classes.cardDescription}>
                    Don{"'"}t be scared of the truth because I need to restart
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                ...
                <CardBody plain>
                  ...
                  >
                    <h4 className={classes.cardTitle}>
                      Light Bootstrap Dashboard For React
                    </h4>
                  </a>
                  ...
                  <p
                    className={classes.description + " " + classes.marginTop20}
                  >
                    Light Bootstrap Dashboard For React is a Bootstrap 4 Admin Theme
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                ...
                <CardBody plain>
                  ...
                  >
                    <h4 className={classes.cardTitle}>
                      Coming Soon UI Dashboard For React
                    </h4>
                  </a>
                  <h6 className={classes.description}>Premium Template</h6>
                  <p
                  ...
                  >
                    ...
                    designed by Invision and coded by Tim Andrus. It is built
              ...
              >
                <CardBody background className={classes.cardBody4}>
                  ...
                  <a href="#pablo" onClick={e => e.preventDefault}>
                    ...
                    <p className={classes.cardDescription}>
                      Don{"'"}t be scared of the truth because I need to
