...
import headersStyle from "assets/jss/nextjs-material-tim-andrus/pages/sectionsSections/headersStyle.js";
        ...
        >
          <div className={classes.conatinerHeader2}>
            <GridContainer>
              ...
              >
                <h1 className={classes.title}>You should work with me!</h1>
                <h4>
          ...
          <div>
            ...
            >
              <div className={classes.container}>
                <GridContainer>
                  <GridItem xs={12} sm={6} md={6}>
                    <h1 className={classes.title}>NextJS Material TIM</h1>
                    <h4>
