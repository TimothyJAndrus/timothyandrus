...
import testimonialsStyle from "assets/jss/nextjs-material-tim-andrus/pages/sectionsSections/testimonialsStyle.js";
      ...
      >
        <div className={classes.container}>
          <GridContainer>
            ...
            >
              <h2 className={classes.title}>My Clients Love Me</h2>
              <h5 className={classes.description}>
                You need more information? Check what other persons are saying
                about my product. They are very happy with their purchase.
              </h5>
            </GridItem>
          </GridContainer>
          <GridContainer>
