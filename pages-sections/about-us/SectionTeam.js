...
import teamStyle from "assets/jss/nextjs-material-tim-andrus/pages/aboutUsSections/teamStyle.js";
  ...
  return (
    <div className={classes.team}>
      <GridContainer>
        ...
        >
          <h2 className={classes.title}>I am a nerd rockstar</h2>
        ...
        <GridItem md={3} sm={3}>
          <Card profile plain>
            ...
            <CardBody plain>
              ...
              <p className={classes.cardDescription}>
                Don{"'"}t be scared of the truth because I need to restart the
          ...
          <Card profile plain>
            ...
            <CardBody plain>
              ...
              <p className={classes.cardDescription}>
                ...
                truth because I need to restart the human foundation.
              </p>
            </CardBody>
            <CardFooter className={classes.justifyContent}>
              <Button href="#pablo" justIcon simple color="facebook">
        ...
        <GridItem md={3} sm={3}>
          <Card profile plain>
            ...
            <CardBody plain>
              ...
              <h6 className={classes.textMuted}>WEB DEVELOPER</h6>
              <p className={classes.cardDescription}>
                And I love you like Kanye loves Kanye. I really need to restart
