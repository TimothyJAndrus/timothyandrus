...
import officeStyle from "assets/jss/nextjs-material-tim-andrus/pages/aboutUsSections/officeStyle.js";
  ...
  return (
    <div className={classes.office}>
      <GridContainer className={classes.textCenter}>
        ...
        >
          <h2 className={classes.title}>My office is my second home</h2>
          <h4 className={classes.description}>
            Here are some pictures from my office. You can see the place looks
