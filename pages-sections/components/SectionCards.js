...
import styles from "assets/jss/nextjs-material-tim-andrus/pages/componentsSections/sectionCards.js";
          ...
          <GridContainer>
            <GridItem xs={12} sm={7} md={7}>
              <div className={classes.title}>
                ...
                <h4>
                  Material Kit Tim is coming with the famous colored shadows.
