...
import styles from "assets/jss/nextjs-material-tim-andrus/pages/componentsSections/footerStyle.js";
        ...
        >
          <GridContainer>
            <GridItem xs={12} sm={4} md={4}>
              <h5>About Me</h5>
              <p>
                Tim Andrus is a startup that creates design tools that make
                the web development process faster and easier.{" "}
              </p>
              <p>
                I love the web and care deeply for how users interact with a
                digital product. I power businesses and individuals to create
          ...
          <div className={classes.footer}>
            <GridContainer>
              ...
              <GridItem xs={12} sm={3} md={3}>
                ...
                <p>
                  Join our newsletter and get news in your inbox every week! I
